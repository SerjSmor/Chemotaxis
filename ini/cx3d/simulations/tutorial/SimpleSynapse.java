...
public class SimpleSynapse {
	...
	public static void main(String[] args) {
		...
		Cell excit = CellFactory.getCellInstance(new double[] {-20,0,-30});
		...
		inhib.setColorForAllPhysicalObjects(Param.BLUE);
		Cell inhib_1 = CellFactory.getCellInstance(new double[] {5,0,40});
		inhib.setNeuroMLType(Cell.InhibitoryCell);
		...
		NeuriteElement axon1 = inhib_1.getSomaElement().extendNewNeurite(up);
		axon.setIsAnAxon(true);
		PhysicalCylinder inhib_1Cyl = axon.getPhysicalCylinder();
