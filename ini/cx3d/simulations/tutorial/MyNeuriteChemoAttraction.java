...
public class MyNeuriteChemoAttraction extends AbstractLocalBiologyModule {
	...
	public MyNeuriteChemoAttraction(String substanceID) {
		this.substanceID = substanceID;
	}
	
	public MyNeuriteChemoAttraction(String substanceID, double branchingFactor) {
		this.substanceID = substanceID;
	...
	public AbstractLocalBiologyModule getCopy() {
		return new MyNeuriteChemoAttraction(substanceID);
	}
	...
	public static void main(String[] args) {
		...
		//Substance attractant1 = new Substance("B",Color.GREEN);
		//ecm.addArtificialGaussianConcentrationZ(attractant, 1.0, 200.0, 160.0);
		...
		neurite.addLocalBiologyModule(new MyNeuriteChemoAttraction("A"));
		...
		neurite1.addLocalBiologyModule(new MyNeuriteChemoAttraction("B"));
		NeuriteElement neurite11 = d.getSomaElement().extendNewNeurite();
		neurite11.getPhysicalCylinder().setDiameter(4.0);
		neurite11.addLocalBiologyModule(new MyNeuriteChemoAttraction("A"));
