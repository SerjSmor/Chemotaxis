...
public class NeuriteChemoAttraction_modified extends AbstractLocalBiologyModule {
	...
	private double branchingFactor = 0.001;
	
	public NeuriteChemoAttraction_modified(String substanceID) {
		this.substanceID = substanceID;
	}
	
	public NeuriteChemoAttraction_modified(String substanceID, double branchingFactor) {
		this.substanceID = substanceID;
	...
	public static void main(String[] args) {
		...
		ecm.addArtificialGaussianConcentrationZ(attractant, 1.0, 800.0, 160.0);
		Substance yellowSubstance = new Substance("Yellow",10, 0.01);
		...
		c.getSomaElement().addLocalBiologyModule(new NeuriteChemoAttraction_modified("Yellow",1) );
		NeuriteElement neurite = c.getSomaElement().extendNewNeurite();
		neurite.getPhysicalCylinder().setDiameter(2.0);
		neurite.addLocalBiologyModule(new NeuriteChemoAttraction_modified("A"));
		
		Cell d = CellFactory.getCellInstance(new double[] {40,0.0,0.0});
		c.setColorForAllPhysicalObjects(Param.X_SOLID_BLUE);
		NeuriteElement neurite1 = d.getSomaElement().extendNewNeurite();
		neurite1.getPhysicalCylinder().setDiameter(3.0);
		neurite1.addLocalBiologyModule(new NeuriteChemoAttraction_modified("Yellow"));
		NeuriteElement neurite11 = d.getSomaElement().extendNewNeurite();
		neurite11.getPhysicalCylinder().setDiameter(4.0);
		neurite11.addLocalBiologyModule(new NeuriteChemoAttraction_modified("A"));
